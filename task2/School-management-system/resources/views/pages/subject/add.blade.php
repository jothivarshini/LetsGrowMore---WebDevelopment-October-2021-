            ...
            <!-- nav end-->
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="user" method="POST" action="{{ route('subject.save') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input id="subject_code" type="text" class="form-control form-control-user @error('subject_code') is-invalid @enderror" name="subject_code" value="{{ old('subject_code') }}" required autocomplete="subject_code" placeholder="Subject Code">
